...
const Hero = () => {
  return (
    <section id='home' className='w-full justify-center  xl:flex-row flex-col gap-10 hero-bg'>

  <div className='relative xl:w-2/5 flex flex-col justify-center w-full max-xl:padding-x pt-28 text-white  section-container text-center sm:text-left p-4  sm:ml-0 lg:ml-10'>
